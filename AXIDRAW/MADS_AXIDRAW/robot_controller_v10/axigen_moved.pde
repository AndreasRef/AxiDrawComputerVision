...
void GenerateArtwork(float xStart, float yStart, float radius, int steps)
{
 ...
 ToDoList = (PVector[]) append(ToDoList, new PVector(xPos+100, yPos+0)); 
 ToDoList = (PVector[]) append(ToDoList, new PVector(xPos+100, yPos+100)); 
 ToDoList = (PVector[]) append(ToDoList, new PVector(xPos+0, yPos+100)); 
 ToDoList = (PVector[]) append(ToDoList, new PVector(xPos, yPos)); 
 /*
  while (i < steps)
  {
