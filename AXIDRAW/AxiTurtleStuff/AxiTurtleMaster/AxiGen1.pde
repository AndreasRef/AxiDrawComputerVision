...
int MousePaperLeft =  0; // original pos 30
int MousePaperRight =  770;
int MousePaperTop =  0; // original pos 62
...
void mousePressed() {
  ...
  { 
    ...
    ToDoList = (PVector[]) append(ToDoList, new PVector(mouseX, mouseY)); 
    ToDoList = (PVector[]) append(ToDoList, new PVector(-31, 0)); //Comm and 31 (lower pen)
    ToDoList = (PVector[]) append(ToDoList, new PVector(mouseX+15, mouseY+15));
    ToDoList = (PVector[]) append(ToDoList, new PVector(-30, 0)); //Command 30 (raise pen)
